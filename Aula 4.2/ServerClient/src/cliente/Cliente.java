...
import utils.certificateHandler;
...
public class Cliente {
    ...
    public void main(String[] args) throws Exception {
        try {
            ...
            PublicKey serverPub = certificateHandler.verifyThenConvert(readFile("cacert.pem") ,readFile("server_cert.pem"));
            PrivateKey clientPriv = certificateHandler.converterByteToPrivKey(readFile("client_key.pk8"));
            
            DH_KeyAgreement dh_instance = new DH_KeyAgreement(clientPriv,serverPub);
